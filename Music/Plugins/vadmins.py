...
bttn = InlineKeyboardMarkup(
    [[InlineKeyboardButton("🔙︙رجــــــوع", callback_data="cbmenu")]]
)


bcl = InlineKeyboardMarkup([[InlineKeyboardButton("🗑️ اغلاق", callback_data="cls")]])
...
async def cbmenu(_, query: CallbackQuery):
    ...
    if not a.can_manage_voice_chats:
        return await query.answer(
            "🤖 الادمن فقط من يمكنه استخدام القائمه !",
            show_alert=True,
        )
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("🗑️ اغلاق", callback_data="cls")],
            ]
        ),
    )
