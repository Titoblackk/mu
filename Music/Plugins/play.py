...
@Client.on_message(command(["","p", f"play@{BOT_USERNAME}"]))
async def play(_, message: Message):
    ...
    if audio:
        ...
        if len(message.command) < 2:
            ...
            photo=thumb, 
            caption=("**إستعمال:** /play [اسم الموسيقى أو رابط يوتيوب أو الرد على الصوت]\n\nإذا كنت تريد تشغيل قوائم التشغيل! حدد واحد من أدناه.\n\n**مزيد من المعلومات في [𝐗𝐄 ❘❘ ⌜𝐁𝐋𝐀𝐂𝐊⌟](t.me/ZAIDSUPPORT)**"),    
